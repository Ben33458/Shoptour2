...
@section('title', 'Fahrzeug bearbeiten: ' . $vehicle->internal_name)

@section('actions')
    <a href="{{ route('admin.vehicles.show', $vehicle) }}" class="btn btn-outline btn-sm">← Zurück</a>
@endsection
...
<form method="POST" action="{{ route('admin.vehicles.update', $vehicle) }}">
        ...
        <div style="padding:20px;display:flex;flex-direction:column;gap:16px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
                <div class="form-group">
                    ...
                    <input type="text" name="internal_name" value="{{ old('internal_name', $vehicle->internal_name) }}"
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="first_registration"
                           value="{{ old('first_registration', $vehicle->first_registration?->format('Y-m-d')) }}"
                           class="form-control">
        ...
        <div style="padding:20px;display:flex;flex-direction:column;gap:16px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px">
                <div class="form-group">
                    ...
                    <input type="number" name="gross_vehicle_weight" value="{{ old('gross_vehicle_weight', $vehicle->gross_vehicle_weight) }}"
                           class="form-control" min="0">
                    @error('gross_vehicle_weight')<div class="hint" style="color:var(--c-danger)">{{ $message }}</div>@enderror
                </div>
                <div class="form-group">
                    <label>Leergewicht (kg)</label>
                    <input type="number" name="empty_weight" value="{{ old('empty_weight', $vehicle->empty_weight) }}"
                           class="form-control" min="0">
                    @error('empty_weight')<div class="hint" style="color:var(--c-danger)">{{ $message }}</div>@enderror
                </div>
                <div class="form-group">
                    <label>Nutzlast (kg)</label>
                    <input type="number" name="payload_weight" value="{{ old('payload_weight', $vehicle->payload_weight) }}"
                           class="form-control" min="0">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
                <div class="form-group">
                    ...
                    <input type="number" name="max_vpe_without_hand_truck" value="{{ old('max_vpe_without_hand_truck', $vehicle->max_vpe_without_hand_truck) }}"
                           class="form-control" min="0">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="max_vpe_with_hand_truck" value="{{ old('max_vpe_with_hand_truck', $vehicle->max_vpe_with_hand_truck) }}"
                           class="form-control" min="0">
        ...
        <div style="padding:20px;display:flex;flex-direction:column;gap:16px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="max_trailer_load" value="{{ old('max_trailer_load', $vehicle->max_trailer_load) }}"
                           class="form-control" min="0">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="required_license_class" value="{{ old('required_license_class', $vehicle->required_license_class) }}"
        ...
        <div style="padding:20px;display:flex;flex-direction:column;gap:16px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:16px">
                <div class="form-group">
                    ...
                    <input type="date" name="tuev_due_date"
                           value="{{ old('tuev_due_date', $vehicle->tuev_due_date?->format('Y-m-d')) }}"
                           class="form-control">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="oil_service_due_date"
                           value="{{ old('oil_service_due_date', $vehicle->oil_service_due_date?->format('Y-m-d')) }}"
                           class="form-control">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
                <div class="form-group">
                    ...
                    <input type="number" name="next_service_km" value="{{ old('next_service_km', $vehicle->next_service_km) }}"
                           class="form-control" min="0">
    ...
    <div style="display:flex;gap:8px;margin-top:16px">
        ...
        <a href="{{ route('admin.vehicles.show', $vehicle) }}" class="btn btn-outline">Abbrechen</a>
    </div>
</form>
@endsection
