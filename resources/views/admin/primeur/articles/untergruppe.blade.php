...
@section('title', 'Primeur – ' . $ugName)

@section('content')
<div class="page-header">
    <h1 style="margin:0;">{{ $ugName }}</h1>
    <p style="margin:.25rem 0 0;color:var(--c-muted);font-size:.9rem;">
        ...
        <a href="{{ route('admin.primeur.articles.warengruppe', urlencode($wgName)) }}">{{ $wgName }}</a> ›
        {{ $ugName }}
    </p>
</div>
    ...
    <div style="overflow-x:auto;">
        <table class="table" style="font-size:.88rem;">
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="6" style="text-align:center;color:var(--c-muted);padding:2rem;">Keine Artikel.</td></tr>
                @endforelse
            </tbody>
